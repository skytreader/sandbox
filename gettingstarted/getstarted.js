...
$(document).ready(function(){
    ...
    /*
    Create a new mesh with spherical geometry.
    */
    ...
    //requestAnimFrame(function(){renderer.render(scene, camera); console.log("y")});
    setInterval(function(){renderer.render(scene, camera); console.log("y");}, 16);
});
